...
/**
 * Generates the thumbnail of an image with a particular size.
 * @param {String} filePath location of the original file.
...
userQueue.process(async (job, done) => {
  ...
  try {
    const mailSubject = 'Welcome to ALX-Files_Manager by Augustus Emmanuel';
    const mailContent = [
      '<div>',
      '<h3>Hello {{user.name}},</h3>',
      'Welcome to <a href="https://github.com/Augustusalx/alx-files_manager">',
      'ALX-Files_Manager</a>, ',
      'a simple file management API built with Node.js by ',
      '<a href="https://github.com/Augustusalx">Augustus Makuochukwu</a>. ',
